...
void Object::render(Shader& shader) {
        ...
        glBindTexture(GL_TEXTURE_2D, texture->metallic);
        glActiveTexture(GL_TEXTURE3);
        glBindTexture(GL_TEXTURE_2D, texture->roughness);/**/
...
Object::Object(shared_ptr<myTexture> Texture, mat4 M) {
        texture = Texture;
        model = glm::mat4(1.0f);
        model = M;
    }
Cube::Cube(shared_ptr<myTexture> texture, mat4 M) :Object(texture, M) {}
...
Sphere::Sphere(shared_ptr<myTexture> texture, mat4 M) :Object(texture, M) {}
...
Quad::Quad(shared_ptr<myTexture> texture, mat4 M) :Object(texture, M) {   }
...
unsigned int Quad::quadVAO = 0;
unsigned int Quad::quadVBO = 0;
